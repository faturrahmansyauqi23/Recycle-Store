...
<div class="container">
        ...
        <div class="button-container">
          <button class="button1" onclick="window.location.href='add.php'">Upload Barang</button>
      ...
      <button class="icon-profil" onclick="window.location.href='profile_penjual.php'">
        <img
            class="icon-profil"
            alt=""
            src="./profile.svg"
      ...
      <button class="icon-notifikasi" onclick="window.location.href='notifikasi2.html'">
        <img
      ...
      <button class="icon-home" onclick="window.location.href='beranda_organik2.html'">
